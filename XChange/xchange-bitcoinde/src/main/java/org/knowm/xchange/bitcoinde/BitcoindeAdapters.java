...
public final class BitcoindeAdapters {
	 ...
	 *
	 * @param bitcoindeOrderbookWrapper
	 *            the exchange specific OrderBook object
	 * @param currencyPair
	 *            (e.g. BTC/USD)
	 * @return The XChange OrderBook
	 */
	public static OrderBook adaptOrderBook(BitcoindeOrderbookWrapper bitcoindeOrderbookWrapper,
		...
		List<LimitOrder> asks = createOrders(currencyPair, OrderType.ASK,
				bitcoindeOrderbookWrapper.getBitcoindeOrders().getAsks());
		List<LimitOrder> bids = createOrders(currencyPair, OrderType.BID,
	 ...
	 */
	public static List<LimitOrder> createOrders(CurrencyPair currencyPair, OrderType orderType,
	 ...
	 */
	public static LimitOrder createOrder(CurrencyPair currencyPair, BitcoindeOrder bitcoindeOrder,
			OrderType orderType, String orderId, Date timeStamp) {

		return new LimitOrder(orderType, bitcoindeOrder.getAmount(), currencyPair, orderId, timeStamp,
