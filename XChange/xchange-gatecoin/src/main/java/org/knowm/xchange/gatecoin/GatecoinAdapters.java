...
public final class GatecoinAdapters {
  ...
  public static OrderBook adaptOrderBook(GatecoinDepthResult gatecoinDepthResult, CurrencyPair currencyPair, int timeScale) {
    ...
    List<LimitOrder> asks = createOrders(currencyPair, OrderType.ASK, gatecoinDepthResult.getAsks());
    List<LimitOrder> bids = createOrders(currencyPair, OrderType.BID, gatecoinDepthResult.getBids());
    Date date = new Date();
    return new OrderBook(date, asks, bids);
  }

  public static List<LimitOrder> createOrders(CurrencyPair currencyPair, OrderType orderType, GatecoinDepth[] orders) {
  ...
  public static LimitOrder createOrder(CurrencyPair currencyPair, GatecoinDepth priceAndAmount, OrderType orderType) {
