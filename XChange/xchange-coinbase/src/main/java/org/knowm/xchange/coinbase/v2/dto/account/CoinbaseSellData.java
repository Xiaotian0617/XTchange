...
public class CoinbaseSellData extends CoinbaseWalletResponseData<CoinbaseSellData.CoinbaseSell> {
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  public static class CoinbaseSell extends CoinbaseWalletResponse {

    @JsonCreator
    CoinbaseSell(@JsonProperty("id") String id, @JsonProperty("status") String status, @JsonProperty("transaction") String transaction, @JsonProperty("commited") boolean committed) {
