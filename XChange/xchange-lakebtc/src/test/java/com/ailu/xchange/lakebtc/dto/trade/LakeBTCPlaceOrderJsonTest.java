...
public class LakeBTCPlaceOrderJsonTest {
  ...
  public void testDeserializeBuyOrder() throws IOException {
    ...
    InputStream is = LakeBTCPlaceOrderJsonTest.class.getResourceAsStream("/trade/example-place-order-data.json");
  ...
  public void testDeserializeSellOrder() throws IOException {
    ...
    // Read in the JSON from the example resources
    InputStream is = LakeBTCPlaceOrderJsonTest.class.getResourceAsStream("/trade/example-place-order2-data.json");
