...
import org.knowm.xchange.dsx.dto.account.*;
...
public interface DSXAuthenticated extends DSX {
   ...
   * @throws IOException
   * @deprecated Use {@link DSXAuthenticatedV2#getInfo(String, ParamsDigest, SynchronizedValueFactory)}
   */
  @Deprecated
  @POST
  @Path("tapi")
   ...
   * @return
   * @throws IOException
   * @deprecated Use {@link DSXAuthenticatedV2#ActiveOrders(String, ParamsDigest, SynchronizedValueFactory, String)}
   */
  @Deprecated
  @POST
  @Path("tapi")
