...
public class CryptoFacilitiesAdapters {
  ...
  public static OrderBook adaptOrderBook(CryptoFacilitiesOrderBook cryptoFacilitiesOrderBook) {
    ...
    List<LimitOrder> asks = createOrders(cryptoFacilitiesOrderBook.getCurrencyPair(), OrderType.ASK, cryptoFacilitiesOrderBook.getAsks());
    List<LimitOrder> bids = createOrders(cryptoFacilitiesOrderBook.getCurrencyPair(), OrderType.BID, cryptoFacilitiesOrderBook.getBids());
