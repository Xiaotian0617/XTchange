...
import com.ailu.bybit.client.APIHttpClient;
import com.ailu.bybit.client.APIRetrofit;
import com.ailu.bybit.client.ApiHttp;
...
import com.ailu.bybit.utils.HttpHeadersEnum;
...
public class APIClient {
    ...
    private final com.ailu.bybit.client.ApiHttp apiHttp;
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                if (body instanceof ResultBody){
                    ...
                    /*if (resultBody.getRetCode()==0){*/
                        return body;
                    /*}*/
                    //throw new APIException(resultBody.getRetMsg());
                }
                return body;
            } else {
