package com.ailu.bybit.websocket;
...
public class WSListener extends WebSocketListener {
     ...
     */
    public void start() {
        String appKey = "ceTfjwDt-5cyazWGQ-vFgalbBe-x0y5jwL4";
        String secert = "W7RLhtdO-YRHjFv1a-cZ9kWJvp-YONaAWgo";
        String nonce = String.valueOf(RandomUtils.nextInt(0, Integer.valueOf(2 ^ 53)));
        Request req = new Request.Builder()
                .header("Api-Nonce", nonce)
                .header("Api-Key",appKey)
                .header("Api-Signature", Signature.signature(secert,"POST","/ws/liujianshu",nonce,"")).url(url).build();
