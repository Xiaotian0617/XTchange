package com.ailu.oneToken.constant;

import com.ailu.oneToken.enums.CharsetEnum;
...
public class APIConstants {
    ...
    public static final String APINONCE = "Api-Nonce";

    public static final String APIKEY = "Api-Key";

    public static final String APISIGNATURE = "Api-Signature";
