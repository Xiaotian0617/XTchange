package com.ailu.oneToken.utils;

import com.ailu.oneToken.client.APIHttpClient;
...
public class Signature {
    ...
    public static String signature(String secretKey, String verb, String signPath, String nonce, String body) {
        ...
        try {
            String sign = signature(secretKey,verb,signPath,nonce,jsonObject);
            if(APIHttpClient.debug){
                System.out.printf("\n================ Sign =================\n");
    ...
    public static String getNonce(){
        return String.valueOf(RandomUtils.nextInt(0, Integer.valueOf(2 ^ 53)));
    }
}
