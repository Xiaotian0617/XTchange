...
public class BitmexOrderResponse {
   ...
   * @param transactionId
   */
  public BitmexOrderResponse(@JSONField(name = "descr") BitmexOrderResponseDescription description, @JSONField(name = "txid") List<String> transactionId) {
  ...
  public static class BitmexOrderResponseDescription {
     ...
     */
    public BitmexOrderResponseDescription(@JSONField(name = "order") String orderDescription, @JSONField(name = "close") String closeDescription) {
